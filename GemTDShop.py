...
SHOP_URL = "http://101.200.189.65:430/gemtd/201803/goods/list/@76561198047094522?hehe=0.2642897393088788"  # @steam ID lets you check for your id
...
dt22 = None
if dtnow.hour < 4:
    dt22 = datetime(dtnow.year, dtnow.month, dtnow.day, 4, 0, 0, 0)
elif dtnow.hour < 16:
    dt22 = datetime(dtnow.year, dtnow.month, dtnow.day, 16, 0, 0, 0)
else:
    tmrw = dtnow + timedelta(days=1)
    dt22 = datetime(tmrw.year, tmrw.month, tmrw.day, 4, 0, 0, 0)
